...
public class runShooter extends CommandBase {
  ...
  @Override
  public void execute() {
    SmartDashboard.putNumber("RPM G", -turret.shooter.getVelocity() * 60);
    SmartDashboard.putNumber("RPM", -turret.shooter.getVelocity() * 60);
    ...
    error = desired + (desired * .05) + (turret.shooter.getVelocity() * 60) / 10000;
